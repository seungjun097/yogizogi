...
import com.green.yogizogi.dto.GoogleRequestDTO;
import com.green.yogizogi.dto.GoogleResponseDTO;
...
public class LoginController {
    ...
    public String oauth_google_check(HttpServletRequest request,
        ...
        GoogleRequestDTO googleOAuthRequest = GoogleRequestDTO
                .builder()
        ...
        //3.토큰요청을 한다.
        ResponseEntity<GoogleResponseDTO> apiResponse = restTemplate.postForEntity(googleAuthUrl + "/token", googleOAuthRequest, GoogleResponseDTO.class);
        //4.받은 토큰을 토큰객체에 저장
        GoogleResponseDTO googleLoginResponse = apiResponse.getBody();
